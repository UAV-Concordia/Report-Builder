...
#include "../../ZBarCodeReader/barcodereader.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_BarCodeReader_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_BarCodeReader_t qt_meta_stringdata_BarCodeReader = {
    {
QT_MOC_LITERAL(0, 0, 13), // "BarCodeReader"
QT_MOC_LITERAL(1, 14, 20), // "on_DecodeImg_clicked"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "BarCodeReader\0on_DecodeImg_clicked\0"
};
...
void BarCodeReader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        BarCodeReader *_t = static_cast<BarCodeReader *>(_o);
        switch (_id) {
        case 0: _t->on_DecodeImg_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject BarCodeReader::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_BarCodeReader.data,
      qt_meta_data_BarCodeReader,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *BarCodeReader::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BarCodeReader.stringdata))
